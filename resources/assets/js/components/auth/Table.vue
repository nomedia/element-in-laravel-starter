          ...
          <div class="modal-body">
           ...
           <form action="" class="form-horizontal">
              ...
              <div class="el-form-item">
                <label class="el-form-item__label" style="width: 100px;"> 显示名： </label>
              ...
              <div class="el-form-item">
                <label class="el-form-item__label" style="width: 100px;">表格名：</label>
                <div class="el-form-item__content" style="margin-left: 100px;">
                  <div class="el-input">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
           ...
           <form action="" class="form-horizontal">
              ...
              <div class="el-form-item">
                <label class="el-form-item__label" style="width: 100px;"> 字段名字 </label>
                <div class="el-form-item__content" style="margin-left: 100px;">
                  <div class="el-input">
                    <input type="text" v-model="list.display_name" class="form-control" value="" />
    ...
    <section class="content">
      <div class="">
        <div class="toolbar">
          <div class="left">
            <div class="row">
              ...
              <div class="col-xs-4">
                <input type="text" class="form-control" v-model="search.name" placeholder="表名">
              </div>


              <div class="col-xs-3">
                <input type="text" class="form-control" v-model="search.display_name" placeholder="显示名">
              </div>
          ...
          <div class="right">
            ...
            <el-button type="default"  @click="refresh" icon="refresh">刷新</el-button>
          </div>
        </div>
        ...
        <span>
          ...
          <el-button @click="updateFields" type="text" size="small">字段</el-button>
...
update:function(){
  ...
  this.$http.put('/api/tables/'+this.list.id,input, {
  }
  ).then((response) => {
  this.formErrors=[];
  this.$notify({
  ...
  this.$http.get('/api/tables',{ params: {search:this.search,per_page:this.paginate.per_page ,page:this.paginate.page } }).then(function (response) {
  ...
  this.$http.post('/api/tables',input, {
  }
  ).then((response) => {
  this.formErrors=[];
  this.$notify({
...
this.update();
  ...
  if(ids.length>0){
  this.$http.post('/api/tables/-1',{_method:'DELETE', ids:ids}).then((response) => {
