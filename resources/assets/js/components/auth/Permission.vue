...
update:function(){
  ...
  this.$http.put(domain+'api/permissions/'+this.list.id,input, {
  }
  ).then((response) => {
  this.formErrors=[];
  this.$notify({
 ...
 // this.loading=true;
  ...
  this.$http.get(domain+'api/permissions',{ params: {search:this.search,per_page:this.paginate.per_page ,page:this.paginate.page } }).then(function (response) {
  ...
  this.$http.post(domain+'api/permissions',input, {
  }
  ).then((response) => {
  this.formErrors=[];
  this.$notify({
...
this.update();
  ...
  this.$http.post(domain+'api/permissions/-1',{_method:'DELETE', ids:ids}).then((response) => {
