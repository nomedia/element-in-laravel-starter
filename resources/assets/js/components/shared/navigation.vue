            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 销售合同已通过经理审批
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 卡片销售合同产品已出库
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-user text-red"></i> 经理已回复了你的跟进记录
                    </a>
                  </li>
                </ul>
              </li>
